...
<xsl:when test="$hasheader">
  <td colspan="3" valign="top" class="diagramtopleft"><xsl:apply-templates select="bridge:header"/></td>
</xsl:when>

<xsl:otherwise>
  <td valign="bottom" colspan="3" class="diagramtopleft"></td>
</xsl:otherwise>

</xsl:choose>

<td valign="bottom" colspan="4" class="diagramnorth"><xsl:apply-templates select="bridge:hand[@seat='N']"/></td>
<td colspan="3" class="topright"/>
</tr><tr class="eastwest">
<td align="left" colspan="4" class="diagramwest"><xsl:apply-templates select="bridge:hand[@seat='W']"/></td>
<td class="diagramcenter" colspan="2">&#160;</td> <!-- added to ensure some space in north/south diagrams -->
<td align="left" colspan="4" class="diagrameast"><xsl:apply-templates select="bridge:hand[@seat='E']"/></td>
</tr><tr class="south">
<td valign="bottom" colspan="3" class="diagrambottomleft"><xsl:apply-templates select="bridge:contract|bridge:lead"/></td>
<td valign="top" colspan="4" class="diagramsouth"><xsl:apply-templates select="bridge:hand[@seat='S']"/></td>
<td colspan="3" class="diagrambottomright"/>
</tr>
</table>
